...
buttonsqrt=tkinter.Button(text='⌫',command=lambda:back(),height=2,width=5,font=('Arial', 14),bd=5,relief='groove').place(x=500,y=280)
buttonsqrt=tkinter.Button(text='√',command=lambda:inputt('**0.5'),height=2,width=5,font=('Arial', 14),bd=5,relief='groove').place(x=500,y=200)
...
his=tkinter.Button(text='History',command=lambda:hist(),height=2,width=5,font=('Arial', 14),bg='orange',bd=5,relief='groove').place(x=500,y=360)
